...
region = 'ap-south-1'
st_catalog = 's3_tables'
database = 'duckdb_poc_data'
table_bucket = 'lumiq-pune-poc-iceberg-bucket'
...
catalog = load_catalog(
        ...
        **{
            "type": "rest",
            "warehouse": f"{account_id}:{st_catalog}/{table_bucket}",
...
table
stg_cust(
  1: customerid: optional long,
  2: customername: optional string,
  3: email: optional string,
  4: phone: optional long,
  5: city: optional string,
  6: age: optional long,
  7: insertedtimestamp: optional timestamptz,
  8: source_file: optional string,
  9: file_name: optional string,
  10: placeholder1: optional string
),
partition by: [],
sort order: [],
snapshot: Operation.APPEND: id=169151332183523453, parent_id=3393710343936623106, schema_id=0
...
>>> with table.update_schema() as update:
...     update.add_column("forecast_demand", StringType(), "ML prediction")
...
<pyiceberg.table.update.schema.UpdateSchema object at 0x73956c0704a0>
>>>
